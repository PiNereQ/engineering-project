...
class MapRepository {
  Future<List<Location>> fetchLocations() async {
    ...
    return [
      Location(shopLocationId: '0', latitude: 52.406374, longitude: 16.925168, shopId: '1'),
      Location(shopLocationId: '1', latitude: 52.406554, longitude: 16.925334, shopId: '3'),
      Location(shopLocationId: '2', latitude: 52.467139, longitude: 16.927121, shopId: '1'),
    ];
  }
